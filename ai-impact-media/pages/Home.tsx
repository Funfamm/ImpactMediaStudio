...
// SIMULATED FOLDER: "Landing Page Assets"
// Added 'color' property to sync title and buttons
const LANDING_FOLDER = [
  { 
    name: "CYBER SOUL", 
  ...
  { 
    name: "NEON HORIZON", 
    url: "https://images.unsplash.com/photo-1535016120720-40c6874c3b13?q=80&w=2664&auto=format&fit=crop",
    color: "#00f3ff" // Neon Blue
  },
  { 
    name: "CHROME HEART", 
    url: "https://images.unsplash.com/photo-1504639725590-34d0984388bd?q=80&w=2574&auto=format&fit=crop",
    color: "#ffffff" // White
  },
  { 
    name: "VELOCITY", 
    url: "https://images.unsplash.com/photo-1614726365723-49faaa5f26c3?q=80&w=2670&auto=format&fit=crop",
...
export const Home: React.FC = () => {
  ...
  useEffect(() => {
    const timer = setInterval(() => {
      setCurrentIndex((prev) => (prev + 1) % LANDING_FOLDER.length);
    }, 6000);
    return () => clearInterval(timer);
  }, []);

  const currentAsset = LANDING_FOLDER[currentIndex];
  ...
  return (
    <div className="relative h-screen w-full bg-black overflow-hidden font-display selection:bg-neon-purple selection:text-white">
      ...
      <div className="absolute inset-0 z-0">
        {LANDING_FOLDER.map((asset, index) => (
          <div
            key={asset.name}
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
               ...
               {navItems.map((item) => (
                 <Link 
                   ...
                   // We use mouse enter events or CSS vars, but simpler to use style for dynamic hover effects isn't easy in React inline. 
                   // Instead, we will apply the color to the icon and text directly to match the theme.
                 >
                    <item.icon 
               ...
               <Link 
                  ...
                  style={{
                    borderColor: `${currentColor}60`, // 60 opacity hex
